...
function inputCheck(el) { //extend Checkboxes
	...
	el.dummy.ref = el;
	if(isIE == false) {el.dummy.style.left = '3px';/*findPosX(el) + 'px';*/ el.dummy.style.top = '0px';}
	//findPosY(el) + 'px';}
	else {el.dummy.style.left = '3px';/*findPosX(el) + 4 + 'px';*/ el.dummy.style.top = '0px';}
	//findPosY(el) + 4 + 'px';}
	el.dummy.onclick = function() {
		if(!this.ref.checked) {
			this.ref.checked = true;
...
function selects(el) { //extend Selects
	...
	el.dummy.style.left = '5%';
	//findPosX(el) + 'px';
	el.dummy.style.top = '0px';
	//findPosY(el) + 'px';
