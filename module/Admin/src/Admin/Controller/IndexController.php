...
class IndexController extends AbstractActionController {
    ...
    protected $userTable, $eventTable, $mediaTable, $eventmediaTable, $friendmediaTable;
...
//                    echo "<pre>";
//                    print_r($user);
//                    print_r($this->getAuthService()->getStorage()->read($user));
//                    exit;
//                        session_start();
//                        $_SESSION['username'] = $request->getPost('username');
...
//    public function filtereventbyuserAction() {
//        $this->security();
//
////        echo "<pre>";
////        print_r($formData);
...
//        
//        $where = array('role' => 2);
//        $users = $this->getUserTable()->fetchAll($where);
//
//        
...
//        $paginator->setCurrentPageNumber($page);
//        $paginator->setItemCountPerPage(ADMIN_QUERY_LIMIT);
//        $event_total = count($res);
//
//        return array('entries' => $paginator,
